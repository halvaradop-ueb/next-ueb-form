        ...
        <section className="flex flex-col items-center justify-center px-4 py-8 text-center">
            ...
            <div className="mb-6">
                ...
                <p className="mt-2 text-lg text-muted-foreground">
                    Bienvenido al Sistema de Información para la Evaluación Docente, basado en el modelo de evaluación
                    360 grados para los programas de posgrado (especializaciones y maestrías) de la Facultad de
                    Ingeniería en Gerencia de Proyectos de la Universidad El Bosque.
                </p>
            </div>
        </section>
    )
